...
- **New Agent Architectures:** (e.g., new variations of ReAct, Reflection, Planning, or Debate).
- **Cybersecurity Use Cases:** New ways to use agents for SOC automation, pentesting, or malware analysis.
- **New Tools:** Interesting integrations between agents and cybersecurity tools (e.g., SIEMs, EDRs, Threat Intel APIs).

### How to Contribute

1. Fork this repository.
2. Create a new branch for your feature or research update (`git checkout -b feature/new-research`).
3. Commit your changes (`git commit -m 'Add new research on XYZ'`).
4. Push to the branch (`git push origin feature/new-research`).
